...
<div class="card">
    <div class="card-body">
      <h5 class="mb-3">Edit Your Slide</h5>
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control  form-control-lg rounded-1 @error('btn_link') is-invalid @enderror" id="btn-link" name="btn_link" placeholder="Btn Link" value="{{ $slide->btn_link }}">
                @error('btn_link')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
          <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control  form-control-lg rounded-1  @error('btn_text') is-invalid @enderror" id="btn-text" name="btn_text" placeholder="Btn Text" value="{{ $slide->btn_text }}">
                @error('btn_text')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
