      ...
      <div id="editable-datatable_wrapper" class="dataTables_wrapper"><div class="dataTables_length" id="editable-datatable_length"></div><table class="table table-striped table-bordered dataTable" id="editable-datatable" style="cursor: pointer;" aria-describedby="editable-datatable_info">
        <thead>
          <tr>
            ...
            <th class="sorting" tabindex="0" aria-controls="editable-datatable" rowspan="1" colspan="1" style="width: 227.2px;">Client Logo</th>
        ...
        @forelse ($clients as $key => $client)
            <tr id="7" class="gradeA odd">
                <td tabindex="1" class="sorting_1">{{ $clients->firstItem() + $key }}</td>
                <td tabindex="1">
                    <img src="{{ url('images/client/') }}/{{ $client->client_logo }}" alt="" style="max-width: 200px; max-height: 100px;">
                </td>
                <td tabindex="1">
                    <a class="btn waves-effect waves-light btn-success mt-2" href="{{ route('clientedit',$client->id ) }}">
                    ...
                    <a class="btn waves-effect waves-light btn-danger mt-2" href="{{ route('clientdelete',$client->id) }}" onclick="return confirm('Are you sure you want to delete?')">
