      ...
      <div id="editable-datatable_wrapper" class="dataTables_wrapper"><div class="dataTables_length" id="editable-datatable_length"></div><table class="table table-striped table-bordered dataTable" id="editable-datatable" style="cursor: pointer;" aria-describedby="editable-datatable_info">
        <thead>
          <tr>
            ...
            <th class="sorting" tabindex="0" aria-controls="editable-datatable" rowspan="1" colspan="1" style="width: 227.2px;">Gallery Image</th>
            <th class="sorting" tabindex="0" aria-controls="editable-datatable" rowspan="1" colspan="1" style="width: 227.2px;">Gallery Category</th>
            <th class="sorting" tabindex="0" aria-controls="editable-datatable" rowspan="1" colspan="1" style="width: 92.417px;">Action</th>
        </tr>
        </thead>
        <tbody>
        @forelse ($gallery_images as $key => $gallery_image)
            <tr id="7" class="gradeA odd">
                <td tabindex="1" class="sorting_1">{{ $gallery_images->firstItem() + $key }}</td>
                <td tabindex="1">
                ...
                <td tabindex="1">
                    ...
                    <a class="btn waves-effect waves-light btn-danger mt-2" href="{{ route('imagedelete',$gallery_image->id) }}" onclick="return confirm('Are you sure you want to delete?')">
